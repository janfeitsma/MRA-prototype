...
class BazelBuilder():
    def __init__(self, verbose: bool = True, debug: bool = False, dryrun: bool = False):
        ...
        self.debug = debug
        self.dryrun = dryrun
    def run(self, clean: bool = False, test: bool = False, scope: str = DEFAULT_SCOPE) -> None:
        """
        Perform the work:
        1. clean (optional)
        2. build
...
def main(**kwargs) -> None:
    ...
    b.run(clean = kwargs.get('clean'), test = kwargs.get('test'), scope = scope)
